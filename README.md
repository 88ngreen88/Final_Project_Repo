...
The dataset used in this project is the Malaria Cell Images Dataset from the National Library of Medicine. I found this data on [kaggle](https://www.kaggle.com/datasets/iarunava/cell-images-for-detecting-malaria). The dataset contains 27,558 blood cell images with equal instances of parasitized and uninfected cells.
